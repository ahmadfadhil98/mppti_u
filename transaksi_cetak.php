...
if (isset($_POST['back'])) {
    ...
    $data = $conn->query("SELECT count(detail_transaksi.id_transaksi) as id FROM detail_transaksi join transaksi on
                        transaksi.id_transaksi=detail_transaksi.id_transaksi where month(tanggal_selesai)='$bulan' and 
